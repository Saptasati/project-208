...
def musicWindow():
    ...
    playButton = Button(window,text="Play", bd=1,width = 10, bg='LightSkyBlue', font = ("Calibri",10))
    playButton.place(x=30,y=200)

    stop=Button(window,text="Stop", bd=1,width = 10, bg='LightSkyBlue', font = ("Calibri",10))
